...
checkpoint_pattern = re.compile(
    r"Current checkpoint:\s*\*\*CMS-SA v0\.2b2[\s\-–—][^*]+\*\*"
)
...
if not checkpoint_pattern.search(readme):
    missing_root_tokens.append("Current checkpoint: **CMS-SA v0.2b2 ...**")
...
report = {
    "schema": "CMS-SA-v0.2b2-readme-mini-repo-audit",
    "passed": passed,
    "errors": len(missing_root_tokens) + len(mini_missing_rule),
    "warnings": 0,
    "accepted_checkpoint_pattern": "CMS-SA v0.2b2",
...
out_md.write_text(
    ...
    f"- warnings: `0`\n"
    f"- accepted_checkpoint_pattern: `CMS-SA v0.2b2`\n"
