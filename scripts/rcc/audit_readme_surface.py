...
checkpoint_pattern = re.compile(r"Current checkpoint:\s*\*\*CMS-SA v0\.2b3a[\s\-–—][^*]+\*\*")
...
if not checkpoint_pattern.search(readme):
    missing_root_tokens.append("Current checkpoint: **CMS-SA v0.2b3a ...**")
...
report = {
    "schema": "CMS-SA-v0.2b3a-readme-mini-repo-audit",
    "passed": passed,
...
out_md.write_text(
    ...
    f"- warnings: `0`\n"
    f"- accepted_checkpoint_pattern: `CMS-SA v0.2b3a`\n"
